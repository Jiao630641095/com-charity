...
;layui.define(["layer", "form"], function (t) {
    ...
    var e = layui.$, i = layui.layer, a = layui.form, l = (layui.hint(), layui.device()), n = "layedit", o = "layui-show", r = "layui-disabled", c = function () {
        var t = this;
        t.index = 0, t.config = {
            tool: ["strong", "italic", "underline", "del", "|", "left", "center", "right", "|", "link", "unlink", "face", "image", "|", "fontup", "fontdown"],
            hideTool: [],
            height: 280
        }
    };
    ...
    var s = function (t, i, a) {
        ...
        var n = t.document, o = e(n.body), c = {
            link: function (i) {
                ...
                var font = e.commonAncestorContainer.parentNode;
                var newSize = font.tagName=="FONT"?font.getAttribute("size"):font.childNodes[0].tagName=="FONT"?font.childNodes[0].getAttribute("size"):3
                n.execCommand("fontSize",false,newSize+1)
            }, fontdown: function (e) {
                var font = e.commonAncestorContainer.parentNode;
                var newSize = font.tagName=="FONT"?+font.getAttribute("size"):font.childNodes[0].tagName=="FONT"?+font.childNodes[0].getAttribute("size"):3
                n.execCommand("fontSize",false,newSize-1)
        ...
        fontup: '<i class="layui-icon layedit-tool-code" title="字体增大" layedit-event="fontup">A+</i>',
        fontdown: '<i class="layui-icon layedit-tool-code" title="字体减小" layedit-event="fontdown">A-</i>',
